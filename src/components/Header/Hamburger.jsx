...
const Hamburger = () => {
  ...
  return (
    <>
      <div className="header__menu relative flex items-center justify-between gap-5">
        ...
        <ul
          className={`open__menu  absolute items-end justify-end flex-col top-8 -left-38 bg-white list-none w-48 p-4 rounded-md border ${
            open ? "flex" : "hidden"
          }`}
        >
          <li>О компании</li>
